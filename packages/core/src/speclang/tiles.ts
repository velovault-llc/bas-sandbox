...
export const TILE_CATALOG: readonly TileTemplate[] = [
  ...
  { kind: 'subject', token: 'cooling-setpoint',  display: 'cooling setpoint',  description: 'Active cooling setpoint (°F).',                  envKey: 'setpoint' },
  { kind: 'subject', token: 'heating-setpoint',  display: 'heating setpoint',  description: 'Active heating setpoint (°F).',                  envKey: 'heating_sp' },
